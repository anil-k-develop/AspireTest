...
import example.example.pages.AspireAppLoginPage;
...
public class BaseTest {
	...
	protected void setup() {
		...
		driver.get(TestProperties.getProperty("app_url"));
		Assert.assertTrue(driver.getTitle().contains("Odoo"), "Title doesn't contain Odoo : Test Failed");
